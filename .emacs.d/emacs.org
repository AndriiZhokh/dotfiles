...
(set-face-attribute 'default nil :font "Iosevka NFP" :height 130) ; set up font
;; (set-face-attribute 'default nil :font "Cascadia Code" :height 120) ; set up font

;; Set the fixed pitch face
(set-face-attribute 'fixed-pitch nil :font "Iosevka NFP" :height 130)
...
#+begin_src emacs-lisp
  ...
  (use-package visual-fill-column
    :init (setq visual-fill-column-width 80
