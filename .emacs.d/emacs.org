...
(set-face-attribute 'default nil :font "Cascadia Mono" :height 120) ; set up font

;; Set the fixed pitch face
;; (set-face-attribute 'fixed-pitch nil :font "Comic Mono" :height 120)
(set-face-attribute 'fixed-pitch nil :font "Cascadia Mono" :height 120)
...
*** Currently everforest theme is not perfect, still has some not usefull coloring related to visual selection need to correct that
